...
<section class="pt-20 relative">
    ...
    <div class="relative overflow-hidden">
        ...
        <div id="bannerSlider" class="relative w-full">
            ...
            <div class="banner-slide {{ $key == 0 ? 'block' : 'hidden' }} relative transition-all duration-700">
        ...
        <div class="absolute bottom-6 left-1/2 -translate-x-1/2 flex space-x-3">
            @foreach($pengumuman as $key => $item)
                <span class="dot w-3 h-3 bg-white rounded-full cursor-pointer {{ $key == 0 ? 'opacity-100' : 'opacity-50' }}"></span>
            @endforeach
        </div>
    ...
    <section id="hero" class="pt-24 pb-16 bg-gradient-to-r from-indigo-600 to-blue-500 text-white">
        <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center">
            ...
            <div class="md:w-1/2 mt-6 md:mt-0" data-aos="fade-left">
                <img src="{{ asset('img/landing.png') }}" alt="Ilustrasi Karya Tulis" class="rounded-lg shadow-lg">
            </div>
        </div>
    </section>
