    ...
    <div class="card stat-card bg-gkm shadow-lg border-0">
        <div class="card-body">
            ...
            <div class="d-flex text-center">
                <div class="stat-item"><h5>{{ $gkmUsers }}</h5><small>Peserta</small></div>
                <div class="stat-item"><h5>{{ $gkmKarya }}</h5><small>Judul</small></div>
                <div class="stat-item"><h5>{{ $gkmProposal }}</h5><small>Makalah</small></div>
                <div class="stat-item"><h5>{{ $gkmFinal }}</h5><small>Final</small></div>
            </div>
        </div>
    </div>
</div>
...
<div class="col-md-4">
    <div class="card stat-card bg-eif shadow-lg border-0">
        <div class="card-body">
            ...
            <div class="d-flex text-center">
                <div class="stat-item"><h5>{{ $eifUsers }}</h5><small>Peserta</small></div>
                <div class="stat-item"><h5>{{ $eifKarya }}</h5><small>Judul</small></div>
                <div class="stat-item"><h5>{{ $eifProposal }}</h5><small>Makalah</small></div>
                <div class="stat-item"><h5>{{ $eifFinal }}</h5><small>Final</small></div>
            </div>
        </div>
    </div>
</div>
...
<div class="col-md-4">
    <div class="card stat-card bg-ss shadow-lg border-0">
        <div class="card-body">
            ...
            <div class="d-flex text-center">
                <div class="stat-item"><h5>{{ $ssUsers }}</h5><small>Peserta</small></div>
                <div class="stat-item"><h5>{{ $ssKarya }}</h5><small>Judul</small></div>
                <div class="stat-item"><h5>{{ $ssProposal }}</h5><small>Makalah</small></div>
                <div class="stat-item"><h5>{{ $ssFinal }}</h5><small>Final</small></div>
            </div>
        </div>
    </div>
</div>
...
new ApexCharts(document.querySelector("#chartPeserta"), {
    ...
    series: [{ data: [{{ $gkmUsers }}, {{ $eifUsers }}, {{ $ssUsers }}] }],
...
new ApexCharts(document.querySelector("#chartDonut"), {
    ...
    series: [{{ $gkmUsers }}, {{ $eifUsers }}, {{ $ssUsers }}],
    labels: ['GKM','EIF','SS'],
    colors: ['#6366f1','#10b981','#38bdf8']
}).render();
...
new ApexCharts(document.querySelector("#chartTahapan"), {
    ...
    series: [
        { name:'Judul', data:[{{ $gkmKarya }},{{ $eifKarya }},{{ $ssKarya }}] },
        { name:'Makalah', data:[{{ $gkmProposal }},{{ $eifProposal }},{{ $ssProposal }}] },
        { name:'Final', data:[{{ $gkmFinal }},{{ $eifFinal }},{{ $ssFinal }}] }
    ],
    xaxis:{ categories:['GKM','EIF','SS'] },
...
new ApexCharts(document.querySelector("#chartFinal"), {
    chart: { type: 'bar', height: 300 },
    series: [{ data:[{{ $gkmFinal }},{{ $eifFinal }},{{ $ssFinal }}] }],
    xaxis:{ categories:['GKM','EIF','SS'] },
    colors:['#22c55e']
}).render();
</script>
