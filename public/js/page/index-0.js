...
// Pastikan elemen canvas ada dan dapatkan konteksnya dengan benar
const canvas = document.getElementById("myChart");
if (canvas) {
    const statistics_chart = canvas.getContext("2d");
    ...
    console.warn("Canvas element not found. Skipping chart creation.");
}
