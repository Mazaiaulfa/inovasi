...
<div class="main-content">
    ...
    <div class="info-item"><strong>Direktorat:</strong> <?php echo e($gugus->direktorat ?? '-'); ?></div>
    <div class="info-item"><strong>Kompartemen:</strong> <?php echo e($gugus->kompartemen ?? '-'); ?></div>
    <div class="info-item"><strong>Unit Kerja:</strong> <?php echo e($gugus->unit_kerja ?? '-'); ?></div>
