...
<script>
    $(document).ready(function () {
        ...
        $('#anggotaForm').submit(function (e) {
           ...
           const url = id ? `<?php echo e(url('user/anggota')); ?>/${id}` : `<?php echo e(route('anggota.store')); ?>`;
        ...
        $('#anggota-table').on('click', '.edit-btn', function () {
            ...
            $.get(`<?php echo e(url('user/anggota')); ?>/${id}/edit`, function (response) {
        ...
        $('#confirmDelete').click(function () {
            $.ajax({
                url: `<?php echo e(url('user/anggota')); ?>/${deleteId}`,
                type: 'DELETE',
                success: function (response) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\inovasirev\resources\views/user/anggota/index.blade.php ENDPATH**/ ?>