                    ...
                    <form action="<?php echo e(route('admin.timeline.store')); ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="urutan" class="form-control"
                                   value="<?php echo e(old('urutan')); ?>" required>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\inovasirev\resources\views/admin/timeline/create.blade.php ENDPATH**/ ?>