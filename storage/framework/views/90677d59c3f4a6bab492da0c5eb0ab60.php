            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?php echo e(route('proposal.store')); ?>" method="POST" enctype="multipart/form-data"
                                class="mb-4">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="tahap_id" class="form-control" required>
                                        ...
                                        <option value="<?php echo e($t->id); ?>">- <?php echo e($t->nama); ?> -
                                            <?php echo e($t->deskripsi); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
